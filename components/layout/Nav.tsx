      ...
      >
        <div className="w-full px-4 md:px-6 h-16 grid grid-cols-[1fr_auto] md:grid-cols-3 items-center">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="font-body font-medium text-[11px] tracking-wide uppercase whitespace-nowrap bg-gradient-to-r from-[#1a8fff] to-[#00d4a0] bg-clip-text text-transparent">
          ...
          <div className="flex items-center justify-end gap-3">
            <Link
              href="/contact"
              className="hidden md:inline-block bg-gradient-to-r from-[#1a8fff] to-[#00d4a0] text-white font-heading text-sm font-semibold px-5 py-2.5 rounded-xl hover:brightness-110 transition-all"
            >
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 h-16">
            <Link href="/" onClick={() => setMobileOpen(false)} className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="font-body font-medium text-[10px] tracking-wide uppercase bg-gradient-to-r from-[#1a8fff] to-[#00d4a0] bg-clip-text text-transparent">
                  Operate With an Edge
                </span>
              </div>
            </Link>
          ...
          <div className="px-6 pb-10 pt-2">
            ...
            <Link
              href="/contact"
              onClick={() => setMobileOpen(false)}
              className="flex items-center justify-center w-full bg-gradient-to-r from-[#1a8fff] to-[#00d4a0] text-white font-heading font-semibold text-sm px-6 py-3.5 rounded-xl hover:brightness-110 transition-all"
            >
