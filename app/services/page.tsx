...
export default function ServicesPage() {
  return (
    <div>
      ...
      {/* ── 01 Audit & Strategy ── */}
      <section id="audit-strategy" className="scroll-mt-40 bg-brand-light py-16 md:py-24 px-4 md:px-6">
      ...
      <section id="optimize-consolidate" className="scroll-mt-40 bg-white py-16 md:py-24 px-4 md:px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
      ...
      {/* ── 03 Build ── */}
      <section id="build" className="scroll-mt-40 bg-brand-dark py-16 md:py-24 px-4 md:px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          {/* Left: text */}
          <div>
